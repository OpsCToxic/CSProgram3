/**
 * Program 3
 *  This program creates four racers that participate in a race. Each racer inherits an abstract class that defines a draw() and morph() method respecively.
 *  
 *  CS160-3
 *  3/6/22
 *  @author  Cameron Cobb
...
public class Certify {
	public static void main(String[] args) {
		...
		System.out.println("My new racer classes are Car and Boat");

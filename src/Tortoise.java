...
public class Tortoise extends Racer
{
   ...
   */
   ...
   /**
 * This morph method adds a stick figure on top of the turtle racer if the turtle finishes first.
 */
@Override
   public void morph(Graphics g) {
	  rand = new Random( );
	  g.setColor( new Color (rand.nextInt(256), rand.nextInt(256), rand.nextInt(256)));
	  g.fillOval(getX() - 15, getY() - 30, 10, 10);
	  g.fillRect(getX() - 12, getY() - 20, 3, 20);
	  g.fillRect(getX() - 14, getY() - 2, 3, 8);
	  g.fillRect(getX() - 10, getY() - 2, 3, 8);
	  g.fillRect(getX() - 10, getY() - 10, 8, 3);
	  g.fillRect(getX() - 20, getY() - 10, 8, 3);
